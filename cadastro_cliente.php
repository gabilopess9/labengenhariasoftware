...
$sql = "INSERT INTO cliente (nome, endereco, cep, cpf, email, tel, Pdata, servico1, servico2, servico3, servico4, servico5) VALUES('$nome', '$endereco', '$cep', '$cpf', '$email', '$tel', '$Pdata', '$servico1', '$servico2', '$servico3', '$servico4', '$servico5')";
